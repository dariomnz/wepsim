...
function mem_ep2_register(sim_p) {
    ...
    sim_p.signals.R = {
        ...
        behavior: ["NOP; CHECK_RTD",
            "FIRE_ONE MMR; MEM_READ MAR_MEM_R BUS_DB BW SE CLK MRDY; CHECK_RTD"],
    ...
    sim_p.signals.W = {
        ...
        visible: true, type: "L", value: 0, default_value: 0, nbits: "1",
        behavior: ["NOP",
            "FIRE_ONE TD; MEM_WRITE BUS_AB BUS_DB BW SE CLK MRDY;"],
    ...
    sim_p.behaviors.MEM_READ = {
        ...
        operation: function (s_expr) {
            ...
            var mrdy = sim_p.signals[s_expr[6]];
            ...
            if (0 == get_value(mrdy)) {
                ...
                var dbvalue = main_memory_extractvalues(value, bw, (address & 0x00000003), se);
                set_value(sim_p.states[s_expr[2]], (dbvalue >>> 0));
                set_value(mrdy, 1);
                show_main_memory(sim_p.internal_states.MP, wordress, false, false);
            }
        },
    ...
    sim_p.behaviors.MEM_WRITE = {
        ...
        operation: function (s_expr) {
            ...
            if (0 == get_value(mrdy)) {
                ...
                main_memory_set(sim_p.internal_states.MP, wordress, melto);

                set_value(mrdy, 1);
                show_main_memory(sim_p.internal_states.MP, wordress, false, true);
            }
        },
        verbal: function (s_expr) {
            var verbal = "";
