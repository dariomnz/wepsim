        ...
        class ws_simmicasm extends ws_uielto
        {
	      ...
	      render ( event_name )
	      {
		    ...
		    var o1 = '<!-- Nav tabs -->' +
			     ...
			     '    	        components="mp,con,wokwi,all,mc,io,cpu,mpcfg,iocfg,iol3d,ioldm,cm,cmcfg,sound"></ws-ddown-sel>' +
			     '    </div>' +
			     '    </div>' +
			     '' +
			     '    <ws-ddown-info components="mp,con,wokwi,all,mc,io,cpu,mpcfg,iocfg,iol3d,ioldm,cm,cmcfg,sound"></ws-ddown-info>' +
			     '  </div>' +
			     '' +
