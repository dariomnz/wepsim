...
export var hash_detail2action = {
    ...
    {
        wsweb_set_details_select(11);
    },

    'CONTROL_MEMORY': function()
    {
        wsweb_set_details_select(16); show_memories_values();
    },
    'CPU_STATS': function()
    {
        wsweb_set_details_select(17); show_memories_values();
    },
    'MEMORY': function()
    {
        wsweb_set_details_select(14); show_memories_values();
    },
    'MEMORY_CONFIG': function()
    {
        wsweb_set_details_select(18); show_memories_values();
    },
    'CACHE': function()
    {
        wsweb_set_details_select(28); show_memories_values();
    },
    'CACHE_CONFIG': function()
    {
        wsweb_set_details_select(29); show_memories_values();
    },
    'KEYBOARD': function()
    {
        wsweb_set_details_select(12); show_memories_values();
    },
    'SCREEN': function()
    {
        wsweb_set_details_select(12); show_memories_values();
    ...
    'IO_STATS': function()
    {
        wsweb_set_details_select(15); show_memories_values();
    },
    'IO_CONFIG': function()
    {
        wsweb_set_details_select(19); show_memories_values();
    },
    '3DLED': function()
    {
        wsweb_set_details_select(25); show_memories_values();
    },
    'LEDMATRIX': function()
    {
        wsweb_set_details_select(27); show_memories_values();
    },
    'SOUND': function()
    {
        wsweb_set_details_select(30); show_memories_values();
    },

    'FRM_EDITOR': function()
    {
        wsweb_set_details_select(20);
        var t3_firm = document.getElementById('t3_firm');
...
export function wsweb_notifyuser_add()
{
    ...
    var dlg_obj = {
        ...
        title: function()
        {
            return 'Form to add a message during playback...' ;
        },
        body: function()
        {
            return bbmsg ;
